...
$F$ & $F$ & $F$ & $F$ & $F$\\
\hline
& & \includegraphics[width=0.5in]{xANDy.png}
&  \includegraphics[width=0.5in]{xXORy.png}
&  \includegraphics[width=0.5in]{xORy.png}
\end{tabular}
\qquad \qquad\qquad
\begin{tabular}{c||c}
Input & Output \\
...
$T$ & $F$ \\
$F$ & $T$\\
\hline & \includegraphics[width=0.5in]{NOTx.png}
\end{tabular}
\end{center}
...
\begin{enumerate}
    ...
    \begin{center}
    \includegraphics[width=2in]{review-circuit-3.png}
    \end{center}
    ...
    \qquad \qquad \qquad
    \includegraphics[width=2in]{review-circuit-4.png}
    \end{center}
