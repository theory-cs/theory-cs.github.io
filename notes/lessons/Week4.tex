...
\subsection*{Review}
\begin{enumerate}
\item \input{../activity-snippets/quiz-building-circuit.tex}
\item \input{../activity-snippets/quiz-redundancy-algorithm.tex}
\item \input{../activity-snippets/quiz-rna-mutation-insertion-deletion.tex}
\end{enumerate}
...
\subsection*{Review}
\begin{enumerate}
\item \input{../activity-snippets/quiz-predicates-finite-domain.tex}
...
\subsection*{Review}
\begin{enumerate}
\item \input{../activity-snippets/quiz-predicates-alternating-quantifiers-rnalen.tex}
\item \input{../activity-snippets/quiz-predicates-alternating-quantifiers-basecount.tex}
\end{enumerate}
