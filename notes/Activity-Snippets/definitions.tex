%! app: 
%! outcome: Model systems with tools from discrete mathematics and reason about implications of modelling choices, Important Number Sets, Data Types, Sets and Functions
