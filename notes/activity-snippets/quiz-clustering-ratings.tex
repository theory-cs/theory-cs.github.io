...
\begin{enumerate}
    ...
    \item What's the greatest diameter of a collection that has exactly two (distinct) ratings $5$-tuples?
    \item What's the least diameter of a collection that has exactly two (distinct) ratings $5$-tuples?
\end{enumerate}